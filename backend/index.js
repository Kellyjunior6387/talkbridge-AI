...
if (!aiKey || !zernioKey || !atKey) {
  ...
  if (!atKey) log('warn', 'Warning: AFRICASTALKING_API_KEY is missing on startup.');
...
log('info', `Africa's Talking API Key detected: ${atKey.slice(0, 8)}...`);
